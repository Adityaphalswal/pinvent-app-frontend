    ...
    <div className='contact'>
        ...
        <div className="section">
            ...
            <div className="details">
                ...
                <div className="icons">
                    <span><FaPhoneAlt/><p>+91 870860XXXX</p></span>
                    <span><FaEnvelope/><p>Adityaph135@gmail.com</p></span>
                    <span><GoLocation/><p>Haryana, India</p></span>
                    <span><FaTwitter/><p>@adityaphalswal</p></span>
                </div>
                </Card>
            </div>
        </div>
